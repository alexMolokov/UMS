...
Component.options.__file = "src/js/pages/order/AssignedOrder.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fe595772", Component.options)
  } else {
    hotAPI.reload("data-v-fe595772", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(87)("41a04444", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-fe595772\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AssignedOrder.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-fe595772\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AssignedOrder.vue");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_error_inform_vue__ = __webpack_require__(94);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mixins_ok_action_inform_vue__ = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mixins_order_states__ = __webpack_require__(367);
//
//
//
//
...
var formBlockAccount = function formBlockAccount() {
    return __webpack_require__.e/* import() */(1/* duplicate */).then(__webpack_require__.bind(null, 362));
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        var path = '/order/assigned/' + this.order.id;
    ...
    computed: {
        isRejected: function isRejected() {
            return __WEBPACK_IMPORTED_MODULE_4__mixins_order_states__["a" /* ORDER_STATES */].isRejected(this.order.state);
        },
        isDone: function isDone() {
            return __WEBPACK_IMPORTED_MODULE_4__mixins_order_states__["a" /* ORDER_STATES */].isDone(this.order.state);
        },
    ...
    methods: {
        reject: function reject() {
            ...
            var self = this;
            this.send("/order/reject", { id: this.order.id, "lang": this.$store.state.lang }, function (data) {
        ...
        accept: function accept() {
            ...
            var self = this;
            this.send("/order/done", { id: this.order.id, "lang": this.$store.state.lang }, function (data) {
                _this3.order.state = data.state;
            }, function () {});
        }
    },
    locales: {
...
var render = function() {
  ...
  return _c("div", { staticClass: "content-wrapper" }, [
    _c("section", { staticClass: "content-header" }, [
      _c("h1", [_vm._v("Заявка на одобрение №" + _vm._s(_vm.order.id))]),
      _vm._v(" "),
      _vm._m(0)
    ]),
    _vm._v(" "),
      ...
      _c("div", { staticClass: "box box-header " }, [
        _c("div", { staticClass: "row" }, [
          ...
          _c(
            "div",
            {
              staticClass: "col-xs-10 col-md-7 col-lg-5",
                  ...
                  [
                    ...
                    _vm.isDone
                      ? _c(
                          ...
                          [_vm._v("Заявка была одобрена и выполнена")]
                        )
                      : _vm._e()
                  ]
                )
...
var staticRenderFns = [
  function() {
    ...
    return _c("ol", { staticClass: "breadcrumb" }, [
      ...
      _vm._v(" "),
      _c("li", { staticClass: "active" }, [_vm._v("Заявка на одобрение")])
    ])
  }
]
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-fe595772", module.exports)
  }
}
...
var ORDER_STATES = {
    statesName: {
        ...
        ru: (_ru = {}, _defineProperty(_ru, ACCEPT, "На одобрении"), _defineProperty(_ru, CANCEL, "Отменен"), _defineProperty(_ru, REJECT, "Отклонен"), _defineProperty(_ru, DONE, "Выполнен"), _ru)
