...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mixins_ok_action_inform_vue__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mixins_ok_action_inform_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__mixins_ok_action_inform_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__BlockForm_vue__ = __webpack_require__(325);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__mixins_states__ = __webpack_require__(15);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
    ...
    methods: {
        ...
        validate: function validate() {
            ...
            this.send("/user/block", data, function (data) {
                ...
                if (data.type == "order") {
                    self.state = __WEBPACK_IMPORTED_MODULE_5__mixins_states__["a" /* STATES */].ANSWER;
                    self.order.id = data.data.id;
                } else {
